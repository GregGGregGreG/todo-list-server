(function ($) {
    ...
    function destroy() {
        ...
        var query = {
            type: 'DELETE',
            url: "http://localhost:8080/api/todo/" + 1555,
    ...
    function showAllAssignedTask() {
        ...
        var query = {
            type: 'GET',
            url: 'http://localhost:8080/api/todo_assigned',
            success: this.addTaskList.bind(this, setCount)
        };
        //Send new request
        this.newTodoResource(query);
