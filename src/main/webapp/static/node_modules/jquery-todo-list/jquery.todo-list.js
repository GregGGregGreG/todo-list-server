(function ($) {
    ...
    function bindEvents() {
        ...
        this.getTaskList()
            ...
            .delegate('#' + this.config.btnCheckTaskId, 'click', this.checkTask.bind(this))
    ...
    function getCurrentStateTask() {
        return {
            ...
            $task: $(event.target).closest('li').find('#' + this.config.taskDeskId),
            $editTask: $(event.target).closest('li').find('#' + this.config.editTaskDeskId),
            $btnUpdateTask: $(event.target).closest('li').find('#' + this.config.btnUpdateTaskId),
            $btnCheckTask: $(event.target).closest('li').find('input#' + this.config.btnCheckTaskId),
            $btnCheckTaskLabel: $(event.target).closest('li').find('span#' + this.config.btnCheckTaskId),
