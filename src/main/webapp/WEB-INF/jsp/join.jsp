...
<div class="container">
    ...
    <c:if test="${empty param.success}">
        <form:form commandName="dto" cssClass="form-signin "><!-- setup-form-container -->
            ...
            <div class="form-group has-feedback">
                ...
                <span class="glyphicon form-control-feedback info-glyphicon" aria-hidden="true"></span><spring:bind path="name">
            ...
            <div class="form-group has-feedback">
                ...
                <c:if test="${empty status.errorMessages}">
                    <div class="text-muted fs-subtitle "><spring:message code="label.user.email.info"/></div>
                </c:if></spring:bind>
            </div>
            <div class="form-group has-feedback">
                ...
                <c:if test="${empty status.errorMessages}">
                    <div class="text-muted fs-subtitle "><spring:message code="label.user.password.info"/></div>
                </c:if></spring:bind>
            </div>
            <div class="form-group has-feedback">
            ...
            <div class="form-group text-center">
                <button type="submit" class="btn btn-lg btn-block btn-success  btn3d " tabindex="5">
                    <spring:message code="label.user.join.submit.button"/></button>
            </div>
