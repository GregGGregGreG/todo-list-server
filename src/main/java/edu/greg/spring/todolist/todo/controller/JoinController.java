...
import edu.greg.spring.todolist.todo.persistence.dto.RegistrationForm;
import edu.greg.spring.todolist.todo.persistence.dto.ValidationResponse;
...
import static edu.greg.spring.todolist.todo.util.TodoView.*;
